...
const ECommerce: React.FC = () => {
  ...
  const [selectedTaskId, setSelectedTaskId] = useState<string | null>(null); // Track clicked task
  ...
  const handleSubmit = (taskId: string) => {
    ...
    // Logic for submitting the reportType (e.g., API call)
    // fetch('/api/submit-report', { method: 'POST', body: JSON.stringify({ taskId, reportType }) });

    // Clear selected task after submission
